...
public class FeedHenryPreferencesPage extends PreferencePage {
	...
	public FeedHenryPreferencesPage(ReferencedComposite composite) {
		super(composite, "FeedHenry");
	}
	...
	private Text findTargetUrl(){
		return new LabeledText(referencedComposite, "Target URL:");
	}
	
	private Text findApiKey(){
		return new LabeledText(referencedComposite, "API Key:");
	}
}
