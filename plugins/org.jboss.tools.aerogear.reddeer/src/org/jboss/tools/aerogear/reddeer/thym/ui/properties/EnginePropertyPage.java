...
public class EnginePropertyPage extends PropertyPage{
	public EnginePropertyPage(ReferencedComposite composite) {
		super(composite, "Hybrid Mobile Engine");
	}
	/**
	...
	public String getVersion (Platform platform){
		String result = null;
		List<TreeItem> tiVersions = new DefaultTree(referencedComposite, 1).getAllItems();
